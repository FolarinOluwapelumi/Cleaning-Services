      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-24">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Reach out to us with your shipping inquiries or to get started.</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500">After contacting us, request a quote for your shipment.</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-black">Schedule Cleaning</h3>
            <p className="text-gray-500">Our experts will professionally pack and handle your items.</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Track your shipment in real-time using our online tracking system.</p>
          </div>
        </div>
      </div>
    </div>
